...
(function() {
  ...
  InformationGroups = (function(_super) {
    ...
    InformationGroups.prototype.parse = function(response) {
      return _(response).reject(function(model) {
        return model.is_deleted;
      });
    };
  ...
  InformationElementView = (function(_super) {
    ...
    InformationElementView.prototype.up = function(event) {
    ...
    InformationElementView.prototype.down = function(event) {
      var myPosition, sortedAbove, swapWith,
        _this = this;
      event.preventDefault();
      console.log('down');
    ...
    InformationElementView.prototype.persist = function() {
      var type;
      type = this.model.get('type');
      if (type === "text") {
        this.model.set({
  ...
  GroupShowView = (function(_super) {
    ...
    GroupShowView.prototype.destroy = function() {
      ...
      this.model.collection.remove(this.model);
      return app.navigate('informations', true);
    };
