...
(function() {
  ...
  InformationGroups = (function(_super) {
    ...
    InformationGroups.prototype.comparator = function(model) {
      return model.get('position');
    };
